...
<script type="text/javascript">
	...
	function bank_transfer_list(){
		var account = ${bank_detail.account_number};
		$.ajax({
			type: "post",
			url: "${path}/bank_transfer_list.mh?${_csrf.parameterName}=${_csrf.token}&account_number=" + account,
...
<div class="main-panel">
	...
	<div class="row col-lg-12">
			...
			<div class="card">
				<div class="card-body">
					...
					<div class="d-sm-flex justify-content-between">
	                  	...
	                  	<button type="button" class="btn btn-outline-twitter btn-sm ms-4 mb-3" id="bank_update" style="font-family: 'IBM Plex Sans KR', sans-serif; font-weight:bold;" >계좌정보 수정</button>
	                </div>
	        		<div class="table-responsive">
						<table class="table table-bordered" style="font-family: 'IBM Plex Sans KR', sans-serif; font-weight:bold;">
	                    	<tbody>
	                    		<tr>
	                    			<td class="table-secondary">계좌명</td>
	                    		...
	                    		<tr>
	                    			<td class="table-secondary">은행명</td>
	                    			<td>${bank_detail.bank}</td>
	                    			<td class="table-secondary">계좌번호</td>
	                    			<td>${bank_detail.account_number}</td>
	                    		</tr>
	                    		<tr>
	                    			<td class="table-secondary">부서명</td>
	                    			<td>${bank_detail.de_name}</td>
	                    			<td class="table-secondary">예금주</td>
	                    			<td>${bank_detail.em_name}</td>
	                    		</tr>
	                    		<tr>
	                    			<td class="table-secondary fw-bold">잔액</td>
	                    			<td class="text-warning">${bank_detail.balance}</td>
	                    			<td class="table-secondary">누적거래금</td>
	                    		...
	                    		<tr>
	                    			<td class="table-secondary">사용용도</td>
		...
		<div class="col-lg-5 d-flex flex-column">
			<div class="card">
				<div class="card-body table-responsive" id="bank_transfer_list">
				<!-- ajax 리콜 result  -->	
				</div>
			</div> <!-- <div class="card">  -->
		</div>

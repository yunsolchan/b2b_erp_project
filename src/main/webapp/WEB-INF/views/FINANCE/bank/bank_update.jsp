...
<div class="row">
          ...
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              <button type="submit" class="btn btn-twitter btn-rounded me-3" style="width:45%; font-family: 'IBM Plex Sans KR', sans-serif; font-weight:bold;">변경</button>
              <button type="reset" class="btn btn-light btn-rounded" style="width:45%; font-family: 'IBM Plex Sans KR', sans-serif; font-weight:bold;">초기화</button>
            </div>
            </form>
          </div>
        </div>

            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
				...
				<div class="btn-group mb-3">
					<button type="button" class="btn btn-outline-twitter" id="financial_statement" style="font-family: 'IBM Plex Sans KR', sans-serif; font-weight:bold;">
						재무상태표
					</button>
					...
					<button type="button" class="btn btn-outline-twitter" id="financial_income_statement" style="font-family: 'IBM Plex Sans KR', sans-serif; font-weight:bold;">
						손익계산서
					</button>		
				</div>
				<div class="row">

...
<head>
  ...
  <title>financial_month_chart</title>
  <!-- plugins:css -->
...
<script type="text/javascript">
	$(function(){
		...
		$("#financial_month_chart").click(function(){
			window.location="${path}/financial_month.mh";
		});
...
<!-- 월별 결산 차트(매출기준) -->
	<div class="content">
		<img src="${path}/resources/image/finance/화면 캡처 2022-04-17 155405.png" width=1500px/>
		...
		<div style="border: 1px solid black">
			<pre>
				월별 매출차트 
				차트 밑에 테이블을 통해 세부 데이터 상황 알 수 있도록
				차트 + 테이블형태 화면구성
				
				제품별 / 가격별매출차트 / 재무상태표 / 손익계산서로 진입할 수 있도록

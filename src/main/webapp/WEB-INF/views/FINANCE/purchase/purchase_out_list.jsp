...
/* 페이징처리 E */
	...
	$(function(){
		$('#purchase_out_list tr td').click(function(){
			var click = $(this);
			var tr = click.parent();
			var td = tr.children();
			/*
...
<body>
<!-- 매출집계표 목록 -->
<table id="purchase_out_list" class="table table-hover" style="font-family: 'IBM Plex Sans KR', sans-serif; font-weight: bold">
		<thead>
		...
		<tbody>
			<c:forEach var="i" items="${purchase_out_list}">
				<tr>

...
<script type="text/javascript">
	$(function(){
		...
		$("#print").click(function(){
			var url = "${path}/expenditure_resolution_detail_print.mh?request_code=" + ${resolution_detail.request_id};
		      window.open(url, "expenditure_resolution_detail_print", "menubar=no, width=800px, height=700px");
		});
	});
</script>
<!-- 지출결의서 상세 -->
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="d-sm-flex justify-content-between">
                  	...
                  	<button type="button" class="btn btn-outline-facebook btn-sm btn-text-icon mb-3" id="print" style="font-family: 'IBM Plex Sans KR', sans-serif; font-weight:bold;">
                  ...
                  <div class="table-responsive">
                    ...
                    <div class="d-sm-flex justify-content-end mt-3">
                    	<button type="button" class="btn btn-outline-twitter btn-text-icon btn-rounded me-2" id="expenditure_resolution_list" style="font-family: 'IBM Plex Sans KR', sans-serif; font-weight:bold;"> <i class="mdi mdi-format-list-bulleted"></i> 지출결의서 목록</button>
                  	</div>
                  </div>
                </div>
              </div>

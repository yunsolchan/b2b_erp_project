...
$(document).ready(function() {
	...
	/* 검색기능 S */
 	$("#keyword").keyup(function() {
        var k = $(this).val();
        console.log(k);
        $("#expenditure_resolution_list > tbody > tr").hide();
        var temp = $("#expenditure_resolution_list > tbody > tr > td:contains('" + k + "')");
        $(temp).parent().show();
	}); 
	/* 검색기능 E */
...
<div class="main-panel">
	...
	<div class="row col-lg-11">
		...
		<table id="expenditure_resolution_list" class="table table-hover" style="font-family: 'IBM Plex Sans KR', sans-serif; font-weight: bold">
			<thead>
				<tr class="table-secondary">
					...
					<th>결의일자<i class="mdi mdi-swap-vertical"></i></th>
				</tr>
			</thead>
			<tbody>
		...
		<div class="d-flex justify-content-end mt-3 mb-3">
			<button type="button" class="btn btn-rounded btn-text-icon btn-outline-twitter" id="expenditure_transfer" style="font-family: 'IBM Plex Sans KR', sans-serif; font-weight:bold;">

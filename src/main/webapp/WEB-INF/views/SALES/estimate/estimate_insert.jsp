...
// 거래처 상품 불러오기
function rowAddd() {
	// client_id를 받아와 id라는 변수에 담아준다
	var id = document.getElementById('client_id').value;
	// id가 null이라면 알럿칭을 띄워주고 리턴으로 함수를 빠져나간다.
	if(!id){
		swal("거래처를 선택해주세요!", {
		       icon: "error" 
		     })
		...
		<div class="card">
          <div class="card-body">
			...
			<div class="form-group">
              ...
              <button type="reset" class="btn btn-light btn-rounded" style="font-family: 'IBM Plex Sans KR', sans-serif; font-weight:bold;">초기화</button>

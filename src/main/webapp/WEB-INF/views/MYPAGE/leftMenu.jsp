         ...
         <li class="nav-item">
          ...
          <div class="collapse" id="form-elements">
            <ul class="nav flex-column sub-menu">
              ...
              <li class="nav-item"><a class="nav-link" href="cost_request.gh" class="link-dark rounded white">비용요청</a></li>
              <li class="nav-item"><a class="nav-link" href="my_request_list.gh" class="link-dark rounded white">요청목록</a></li>
            </ul>
          </div>
        </li>
        <li class="nav-item">

              ...
              <div class="form-group">
                ...
                <div class="input-group col-xs-12">
                  ...
                  <div class="input-group-append" style="margin-left: 10px;">
                    <button class="file-upload-browse btn btn-primary" type="button" style="padding: 9px 8px;">Upload</button>
                  </div>
                </div>
              </div>   
             ...
             <!-- 이름 -->  
              ...
              <div class="form-group">
                ...
                <div class="col-sm-3 row" style="flex-wrap: nowrap; padding-left: 1%;">
                   <input type="number" class="form-control" maxlength="3" oninput="numberMaxLength(this);" name="phone1" required /> 
                   &nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;
                   <input type="number" class="form-control" maxlength="4" oninput="numberMaxLength(this);" name="phone2" required />
                   &nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;
                   <input type="number" class="form-control" maxlength="4" oninput="numberMaxLength(this);" name="phone3" required />
                </div>
              </div>
             ...
             <!-- 주민등록번호 -->  
              <div class="form-group">
                <label for="exampleInputName1"><i class="mdi mdi-checkbox-marked-circle"></i>&nbsp;주민등록번호</label>
                  <div class="col-sm-3 row" style="flex-wrap: nowrap; padding-left: 1%;">
                    <input type="text" class="form-control" maxlength="6" oninput="numberMaxLength(this);" name="regi_num1" required /> 
                    &nbsp;&nbsp;&nbsp;-&nbsp;&nbsp;&nbsp;
                    <input type="password" class="form-control" maxlength="7" oninput="numberMaxLength(this);" name="regi_num2" required />
                 </div>
              </div>
              ...
              <div class="form-group">
                <label for="exampleInputName1"><i class="mdi mdi-checkbox-marked-circle"></i>&nbsp;우편번호</label>
                   <div class="col-sm-2 row" style="flex-wrap: nowrap; padding-left: 1%;">
                      <input type="number" class="form-control" id="zip_code" name="zip_code" required readonly />
              ...
              <div class="form-group">
                ...
                <input type="number" class="form-control" maxlength="9" oninput="numberMaxLength(this);" name="salary" required />
              </div>
              ...
              <div class="form-group">
                ...
                <input type="number" class="form-control" maxlength="20" oninput="numberMaxLength(this);" name="account_number" id="account_number" required/>
                <!-- 계좌 중복체크 버튼 S -->
                   <div class="input-group-append" style="margin-top: 10px;">
              ...
              <div class="form-group">
                ...
                <input type="number" class="form-control" maxlength="5" oninput="numberMaxLength(this);" name="annual_count" required />
              </div>
              ...
              <button class="btn btn-light" onClick="window.close()">Cancel</button>

...
<div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h3 class="card-title">신규 부서등록</h3>
            ...
            <div id="result">
              ...
              <div class="form-group">
                <label for="exampleInputName1"><i class="mdi mdi-checkbox-marked-circle"></i>&nbsp;우편번호</label>
                	<div class="col-sm-2 row  ms-3" style="flex-wrap: nowrap;">
              ...
              <div class="d-sm-flex justify-content-between form-group">
            	<button class="btn btn-outline-light btn-rounded ms-2" style="width: 45%; font-family: 'IBM Plex Sans KR', sans-serif; font-weight: bold">초기화</button>
            	<button type="submit" class="btn btn-outline-twitter btn-rounded me-2" style="width: 45%; font-family: 'IBM Plex Sans KR', sans-serif; font-weight: bold">등록</button>
              </div>
            </div>

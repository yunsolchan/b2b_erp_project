...
<script type="text/javascript">
	$(document).ready(function() {
		...
		function dept_insert() {
			...
			window.open(url, "dept_insert", "menubar=no, width=580px, height=700px");  // (url, "별칭", size);  
		}
	</script>
</head>
<body>
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="d-sm-flex justify-content-between mb-4">
                  	<p class="card-description">부서목록</p>
                  	<div id="input-form">
                  	<div class="d-sm-flex">
                  ...
                  <!-- <form name="dept_list"> -->
                    <table class="table table-hover" id="dept_list" style="font-family: 'IBM Plex Sans KR', sans-serif; font-weight:bold;">
                      <thead>
                  ...
                  <div class="d-flex justify-content-end mt-3 mb-3">
	                  <button class="btn btn-rounded btn-outline-twitter btn-text-icon me-2" onclick="dept_insert()"  style="font-family: 'IBM Plex Sans KR', sans-serif; font-weight:bold;">

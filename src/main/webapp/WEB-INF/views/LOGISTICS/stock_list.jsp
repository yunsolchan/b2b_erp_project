...
$(document).ready(function() {
   ...
   /* 검색기능 S */
    $("#keyword").keyup(function() {
        var k = $(this).val();
        console.log(k);
        $("#stock_list > tbody > tr").hide();
        var temp = $("#stock_list > tbody > tr > td:contains('" + k + "')");
        $(temp).parent().show();
   }); 
   /* 검색기능 E */
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="table-responsive">
                    <table class="table table-hover" id="stock_list" style="font-family: 'IBM Plex Sans KR', sans-serif; font-weight:bold;">
                      <thead>
                        <tr class="table-secondary">
                          <th>랙코드<i class="mdi mdi-swap-vertical"></i></th>
                          <th>상품코드<i class="mdi mdi-swap-vertical"></i></th>
                          <th>상품명<i class="mdi mdi-swap-vertical"></i></th>
                          <th>수량<i class="mdi mdi-swap-vertical"></i></th>
                         <!--  <th>입고일자</th> -->
                          <th>위치<i class="mdi mdi-swap-vertical"></i></th>
                        </tr>
                      </thead>
                      <tbody>

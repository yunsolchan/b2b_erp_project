...
$(document).ready(function() {
   ...
   /* 검색기능 S */
    $("#keyword").keyup(function() {
        var k = $(this).val();
        console.log(k);
        $("#deliver_history_list > tbody > tr").hide();
        var temp = $("#deliver_history_list > tbody > tr > td:contains('" + k + "')");
        $(temp).parent().show();
   }); 
   /* 검색기능 E */
	...
	$(function(){
	    ...
	    $('#deliver_history_list tr td').click(function(){
	       var click = $(this);
	       var tr = click.parent();
	       var td = tr.children();
...
<body>
          <table class="table table-hover" id="deliver_history_list" style="font-family: 'IBM Plex Sans KR', sans-serif; font-weight:bold;">
            <thead>
               <tr class="table-secondary">
                 ...
                 <th>출고여부<i class="mdi mdi-swap-vertical"></i></th>
               </tr>
            </thead>
            <tbody>
	            ...
	            <tr>
	              ...
	              <td>
	              	<c:if test="${deliver.outbound_status == '출고대기'}">
	              		<label class="badge badge-danger" style="font-family: 'IBM Plex Sans KR', sans-serif; font-weight:bold;">${deliver.outbound_status}</label>
	              	</c:if>
	              	<c:if test="${deliver.outbound_status == '출고완료'}">
	              		<label class="badge badge-info" style="font-family: 'IBM Plex Sans KR', sans-serif; font-weight:bold;">${deliver.outbound_status}</label>
	              	</c:if>
	              </td>
	            </tr>
            </c:forEach>

...
function rowDelete(){
   ...
   $(function(){
      $("#client_insert_action").click(function(){
         window.location="${path}/client_insert_action.test";
      });
   });
...
<div class="row">
          ...
          <div class="card-body">
            ...
            <form class="forms-sample" name= "joinform" method="post" enctype="Multipart/form-data" action="client_insert_action.test?${_csrf.parameterName}=${_csrf.token}">
            <div id="result">

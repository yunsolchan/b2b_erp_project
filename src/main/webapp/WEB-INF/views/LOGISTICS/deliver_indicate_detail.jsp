                  ...
                  <div class="table-responsive">
                    <table class="table table-bordered"style="font-family: 'IBM Plex Sans KR', sans-serif; font-weight:bold;" >
			          ...
			          <tbody>
			            ...
			            <tr>
			              ...
			              <th class="right" rowspan="5" width="25%">
			        ...
			        <table class="table table-bordered"style="font-family: 'IBM Plex Sans KR', sans-serif; font-weight:bold;" >
		             ...
		             <div class="d-sm-flex justify-content-end mb-3 mt-3">
		                <button type="button" class="btn btn-outline-facebook btn-rounded btn-fw btn-icon-text"  onclick="window.print();"style="font-family: 'IBM Plex Sans KR', sans-serif; font-weight:bold;" >

 ...
 <style>
   ...
   $(document).ready(function() {
	...
	$(function(){
	    ...
	    $('#arrival_history_list tr td').click(function(){
	       var click = $(this);
	       var tr = click.parent();
	       var td = tr.children();
...
<body>
                  <table class="table table-hover" id="arrival_history_list" style="font-family: 'IBM Plex Sans KR', sans-serif; font-weight:bold;">
                    <thead>
                      <tr class="table-secondary">
                        ...
                        <th>입고여부<i class="mdi mdi-swap-vertical"></i></th>
                      </tr>
                    </thead>
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                        	<c:if test="${arrival.inbound_status == '입고대기'}">
                        		<label class="badge badge-danger"style="font-family: 'IBM Plex Sans KR', sans-serif; font-weight:bold;">${arrival.inbound_status}</label>
                        	</c:if>
                        	<c:if test="${arrival.inbound_status == '입고완료'}">
                        		<label class="badge badge-info"style="font-family: 'IBM Plex Sans KR', sans-serif; font-weight:bold;">${arrival.inbound_status}</label>
                        	</c:if>
                        </td>
                      </tr>
                      </c:forEach>

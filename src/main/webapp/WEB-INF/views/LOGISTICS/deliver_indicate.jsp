...
<body>
              <div class="card">
                <div class="card-body">
                  ...
                  <form name="deliver_indicate_form" action="${path}/deliver_indicate_action.dh" method="post"> 
                  ...
                  <div class="table-responsive">
                    <table class="table table-bordered" style="font-family: 'IBM Plex Sans KR', sans-serif; font-weight:bold;" >
			          ...
			          <tbody>
			            ...
			            <tr>
			              <th class="table-light" rowspan="5" width="5%" style="border:1px">출고창고정보</th>
			              <th class="right" rowspan="5" >
			              	창고명 : ${dto.wa_name}<br><br>
			              	우편번호 : ${dto.wa_zip_code} <br><br>
			              	주소  : ${dto.wa_address}<br><br>
			              	상세주소 : ${dto.wa_detail_address}
			              </th>
			              <td class="table-light">주문번호</td>
			              <td class="right">${dto.outbound_id}</td>
                    ...
                    <div class="d-sm-flex justify-content-end mb-3 mt-3 me-2">
		                <button type="button" class="btn btn-rounded btn-outline-twitter btn-fw" onclick="window.location='deliver_indicate_action.dh?request_id=${dto.request_id}'" style="font-family: 'IBM Plex Sans KR', sans-serif; font-weight:bold; width:150px" >
			              	출하확인
		         		</button>
		         	</div>
		         	</div>

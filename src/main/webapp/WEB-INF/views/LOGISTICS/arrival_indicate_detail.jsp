                  ...
                  <div class="table-responsive">
                    <table class="table table-bordered" style="font-family: 'IBM Plex Sans KR', sans-serif; font-weight:bold;">
			          ...
			          <tbody>
			            ...
			            <tr>
			              <th class="table-light" rowspan="5" width="10%" style="border:1px">입고창고정보</th>
			              ...
			              <td class="right" width="10%">${dto.inbound_id}</td>
			              
			              <th class="table-light" rowspan="5" width="10%" style="border:1px">거래처정보</th>
			              <th class="right" rowspan="5" width="30%">
			        ...
			        <table class="table table-bordered" style="font-family: 'IBM Plex Sans KR', sans-serif; font-weight:bold;">
		             ...
		             <div class="d-sm-flex justify-content-end mb-3 mt-3 me-2">
		                <button type="button" class="btn btn-rounded btn-outline-facebook btn-icon-text btn-fw" onclick="window.print();" style="font-family: 'IBM Plex Sans KR', sans-serif; font-weight:bold;">
			              	<i class="ti-printer btn-icon-preppend"></i> 입하지시서 출력
		         		</button>
		         	</div>
		         </div>
		      </div>	  

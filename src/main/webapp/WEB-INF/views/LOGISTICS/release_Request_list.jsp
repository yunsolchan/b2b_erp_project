...
<body>
         <table class="table table-hover" id="release_Request_list" style="font-family: 'IBM Plex Sans KR', sans-serif; font-weight:bold;">
           <thead>
          ...
          <c:forEach var="release" items="${list}">
             <tr onclick="window.open('release_indicate.dh?request_id=${release.request_id}&wh_id=${release.wh_id}&outbound_id=${release.outbound_id}', 'release_indicate', 'menubar=no, width=1000px, height=450px')">
               ...
               <label class="badge badge-danger" style="font-family: 'IBM Plex Sans KR', sans-serif; font-weight:bold;">
                 	 <fmt:formatDate value="${release.begin_date}" pattern="yyyy-MM-dd" />
               </label>
               </td>

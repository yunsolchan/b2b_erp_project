...
<script type="text/javascript">
   $(function(){
      ...
      $('#sales_status').click(function(){
     	  
          window.location="${path}/sales_status.jh";
       });      
   });
</script>
<script type="text/javascript">
   $(function(){
      ...
      $('#sales_list tr').click(function(){
         var tr = $(this);   // 현재 클릭한 tr
         var td = tr.children();   // 클릭한 tr의 요소(td)
         
         window.location="${path}/sales_detail.jh";
      });
   });
</script>
<script>
          ...
          <div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card" id="print">
                <div class="card-body">
                  <h3 class="card-title">판매 조회</h3>
                  <p class="card-description">
                          회사명 : (주)team_one
                  </p>
                  <div class="table-responsive">
                    <table class="table table-hover" id="sales_list2">
                      <thead>
                        <tr>
                          <th></th>
                          <th>일자-No.</th>
                  ...
                  <button type="submit" class="btn btn-primary" id="sales_status">
                       판매현황
                  </button>

...
<script type="text/javascript">
   $(function(){
      ...
      $('#estimate_insert').click(function(){
	      ...
	      window.open(url, "estimate_insert", "menubar=no, width=500px, height=700px");  // (url, "별칭", size);  
       }); 
   });
</script>
<script type="text/javascript">
   $(function(){
	      ...
	      $('#estimate_list tr td').click(function(){
	         ...
	         window.location="${path}/estimate_detail.jh?request_id="+ tdd.eq(1).text();
	      });
	   });   
</script>
<script>
              ...
              <div class="card" id="print">
                <div class="card-body">
                  ...
                  <div class="table-responsive">
                    <table class="table table-hover" id="estimate_list2">
                      <thead>
                        <tr>
                          <th></th>
                          <th>견적번호</th>
                  ...
                  <button type="submit" class="btn btn-outline-primary btn-fw" id="estimate_insert">
                       견적서 등록
                  </button>

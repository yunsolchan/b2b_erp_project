...
<script type="text/javascript">
   $(function(){
      ...
      $('#client_insert').click(function(){
	      ...
	      window.open(url, "client_insert", "menubar=no, width=500px, height=700px");  // (url, "별칭", size);  
       }); 
            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card" id="print">
                <div class="card-body">
                  ...
                  <form action="${path}/client_delete.jh" name="clientForm">
                  ...
                  <button type="button" class="btn btn-outline-primary btn-fw" id="client_insert">
                       거래처 등록
                  </button>
                  
                  <button type="button" class="btn btn-outline-primary btn-fw" id="client_delete">
                       거래처 삭제
                  </button>     
                  
                  <button type="button" class="btn btn-outline-primary btn-fw" id="client_print">
                       거래처 목록다운로드
                  </button>                               
               </form>   

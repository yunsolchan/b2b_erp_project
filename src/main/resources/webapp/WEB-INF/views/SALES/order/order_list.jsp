...
<script type="text/javascript">
   $(function(){
      ...
      $('.order_confirm').click(function() {
          ...
          swal("적요를 입력해주세요.", {
             content: "input",
              ...
              window.location="${path}/order_update.jh?request_id="+td.eq(1).text()+"&abst="+value; 
           });
      ...
      $('.outbound').click(function(){
          ...
          var tr = my.parent().parent();
          var td = tr.children();
          var url = "${path}/outbound_insert.jh?request_id="+td.eq(1).text()
          window.open(url, "outbound","menubar=no, width=500px, height=700px");
       })      
...
<script type="text/javascript">
   $(function(){
	      ...
	      $('#order_list tr td').click(function(){
	         ...
	         window.location="${path}/order_detail.jh?request_id="+ tdd.eq(1).text();
	      });
	   });   
</script>
<script>
              ...
              <div class="card" id="print">
                <div class="card-body">
                  ...
                  <div class="table-responsive">
                    <table class="table table-hover" id="order_list2">
                      <thead>
                        <tr>
                          <th></th>
                          <th>주문 번호</th>
                      ...
                      <tbody id="order_list">
                        ...
                        <tr>
                          ...
                          <th> <!-- REQUEST -->
                             ...
                             <label class="badge badge-dark outbound">출고요청</label>
                             </c:if>
                             <c:if test="${dto.re_status eq'요청' }">
                             <label class="badge badge-danger">출고대기</label>
                             </c:if>

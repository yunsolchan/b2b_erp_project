...
<body>
  <div class="card-body">
     <form class="forms-sample" name= "cost_request" method="post" action="salary_cost_request_action.gh" >
            ...
            <div id="result">
              ...
              <div class="form-group">
                ...
                <select class="js-example-basic-single form-control" name="what_cost" required>
	                ...
	                <option value="육아비용">육아비용</option>
	                <option value="운전보조금">운전보조금</option>
              	</select>
              </div>

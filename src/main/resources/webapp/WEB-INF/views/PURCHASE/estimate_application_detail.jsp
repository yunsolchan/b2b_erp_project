...
<head>
  ...
  <title>estimate_application_detail</title>
  <!-- plugins:css -->
...
<script type="text/javascript">
   $(function(){
	   $.ajax({
		    type: "post",
		    url: "${path}/estimate_application_list.sc?${_csrf.parameterName}=${_csrf.token}",
		    success: function(result){   
		    	var e = $(result).find('#estimate_application_list')
		       $('#estimate_application_list').html(e);
		    },
		    error: function(){
		       alert("table ajax 오류");
		    }
          ...
          <div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card" id="print">
                <div class="card-body">
                  <h3 class="card-title">견적서신청서 상세</h3>
                  ...
                  <div class="table-responsive">
                    ...
                    <br><br><br>
                  <button type="submit" class="btn btn-outline-primary btn-fw" id="estimate_application_update">
                       수정
                  </button>
                  
                  <button type="submit" class="btn btn-outline-primary btn-fw" id="estimate_application_delete">
                       삭제
                  </button>     
                  ...
                  <button type="submit" class="btn btn-outline-primary btn-fw" id="estimate_application_print">
         PDF 다운로드
                  </button>                    
                  </div>

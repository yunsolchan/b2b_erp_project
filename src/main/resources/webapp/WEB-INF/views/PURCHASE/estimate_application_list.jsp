...
<head>
  ...
  <title>estimate_application_list</title>
  <!-- plugins:css -->
...
<script type="text/javascript">
   $(function(){
      ...
      $('#estimate_list tr td').click(function(){
          ...
          console.log(tr);
          var tdd = tr.children();
         window.location="${path}/estimate_application_detail.sc?request_id="+tdd.eq(1).text();
      });
   });
</script>
<script>
          ...
          <div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card" id="print">
                <div class="card-body">
                  <h3 class="card-title">견적서신청 목록</h3>
                  <p class="card-description">
                          견적서신청 목록
                  </p>
                  <div class="table-responsive">
                    <table class="table table-hover" id="estimate_application_list">
                      <thead>
                        <tr>
                          <th></th>
                          <th>견적신청서 번호</th>
                ...
                <button type="submit" class="btn btn-outline-primary btn-fw" id="estimate_application_insert">
                       견적신청서 등록
                  </button>   

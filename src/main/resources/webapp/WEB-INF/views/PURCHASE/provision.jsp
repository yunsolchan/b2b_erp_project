...
<script type="text/javascript">
   $(function(){
	   $('#unclaimed').click(function(){
	         ...
	         window.location="${path}/unclaimed.sc";
	      });
      ...
      $('#provision_print').click(function(){
          window.print();
       });      
   });
</script>
<script type="text/javascript">
   $(function(){
      ...
      $('#provision_list tr').click(function(){
              ...
              <div class="card" id="print">
                <div class="card-body">
                  ...
                  <div class="table-responsive">
                    ...
                    <button type="button" class="btn btn-primary" id="unclaimed">미청구 현황</button>
                    <button type="button" class="btn btn-primary" id="purchase_request">매입청구서현황</button>
                  <button type="submit" class="btn btn-outline-primary btn-fw" id="provision_print">
                       지급현황 다운로드
                  </button>                               

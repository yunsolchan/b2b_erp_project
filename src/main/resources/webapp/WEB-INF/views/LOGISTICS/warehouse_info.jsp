...
<body>
  ...
  <%@ include file="/WEB-INF/views/header.jsp" %>
    ...
    <!--    <div class ="btn-group">
                 <button class="btn btn-outline-primary" type="button" id="warehouse_list">창고목록</button>
                 <button class="btn btn-outline-primary" type="button" id="warehouse_insert">창고등록</button>
                </div> -->
          <div class="row">

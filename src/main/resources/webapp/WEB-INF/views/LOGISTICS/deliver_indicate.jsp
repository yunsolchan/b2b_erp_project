                  ...
                  <div class="table-responsive">
                    <table class="table table-bordered">
			          ...
			          <tbody>
			            ...
			            <tr>
			              <th class="table-light" rowspan="5" width="5%" style="border:1px">출고<br><br>창고<br><br>정보</th>
			              ...
			              <th class="table-light" rowspan="5" width="5%" style="border:1px">거래처<br><br>정보</th>
			              <th class="right" rowspan="5" >
			              	거래처명 : ${dto.cl_name}<br>
                    ...
                    <div align="center" style="margin:20px">
		                <button type="button" class="btn btn-outline-primary btn-fw" onclick="window.location='deliver_indicate_action.dh?request_id=${dto.request_id}'">
			              	출하확인
		         		</button>
		         	</div>
		         	</div>

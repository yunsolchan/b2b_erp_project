        ...
        <p class="card-description">
	      ...
	      <div class="table-responsive pt-3">
   				<div class="btn-group mb-3">
					<button type="button" class="btn btn-outline-primary" onclick="emp_update()" value="${dto.employee_id}" id="emp_id">사원정보수정</button>
					<button type="button" class="btn btn-outline-primary" onclick="emp_pdf()">재직증명서</button>		
				</div>

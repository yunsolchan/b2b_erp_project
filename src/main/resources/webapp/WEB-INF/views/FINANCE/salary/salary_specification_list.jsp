...
<script type="text/javascript">
	$(function(){
		$('#salary_specification_list tr').click(function(){
			...
			*/
			window.location="${path}/salary_specification_detail_list.mh?salary_date="+ td.eq(0).text();
		});
	});
</script>
<!-- 급여명세서 목록 -->
<div class="row">
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h3 class="card-title">월별 급여목록</h3>

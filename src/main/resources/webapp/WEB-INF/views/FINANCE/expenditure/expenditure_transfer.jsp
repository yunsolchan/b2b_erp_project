          ...
          <div class="card-body">
            ...
            <div id="result">
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control pt-3 pb-3" id="exampleInputName1" name="account_title" placeholder="해당 지출의 계정과목을 입력해주세요!" required />
              </div>
            ...
            <div class="form-group">
              ...
              <select class="js-example-basic-single form-control" name="account_number" required>
                <c:forEach var="i" items="${bank_list}">
            	  ...
            	  <button type="reset" class="btn btn-light" style="width:48%">초기화</button>
	              <button type="submit" class="btn btn-primary me-3" style="width:48%" id="transfer_submit">송금완료</button>
